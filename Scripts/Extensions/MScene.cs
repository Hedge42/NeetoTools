    ...
    public static class MScene
    {
        ...
        static void Init()
        {
            ...
            EditorSceneManager.sceneClosing += (_, _) =>
            {
                ...
                var orientation = new Orientation(view.pivot, view.rotation);
            ...
            EditorSceneManager.activeSceneChangedInEditMode += (_, _) =>
            {
                ...
                if (EditorPrefs.HasKey(scene.path))
                {
                    ...
                    var orientation = JsonUtility.FromJson<Orientation>(json);
                    var view = SceneView.lastActiveSceneView;
        ...
        public static LayerMask clickLayers => MLayer.Level | MLayer.Terrain;
        ...
        {
            var result = Physics.Raycast(mouseViewRay, out var hit, 100, MLayer.Environment, QueryTriggerInteraction.Ignore);
            position = hit.point;
