...
public struct Module
{
    ...
    // add more as needed
    public static readonly Module MATCHWORK = "Matchwork.Gylfie";
    public static readonly Module UNITY_ENGINE = "UnityEngine";
    public static readonly Module INPUT_SYSTEM = "Unity.InputSystem";
    public static readonly Module CORE = "UnityEngine.CoreModule";
    public static readonly Module PHYSICS = "UnityEngine.PhysicsModule";
    public static readonly Module UI = "UnityEngine.UI";
    public static readonly Module WWISE = "AK.Wwise.Unity.API.WwiseTypes";
    public static readonly Module WWISE_API = "AK.Wwise.Unity.API";
    public static readonly Module WWISE_MONO = "AK.Wwise.Unity.MonoBehaviour";
    public static readonly Module PROJECT = "Assembly-CSharp";
    public static readonly Module EPOOUTLINE = "EPOOutline";
    public static readonly Module VFX = "UnityEngine.VFXModule";
    public static readonly Module STEAM = "MWS.Steam";

    public static readonly Module ALL = new Module
    (
        MATCHWORK,
        UNITY_ENGINE,
        INPUT_SYSTEM,
...
public static class MReflect
{
    ...
    public static bool ToEvent(string signature, out EventInfo info)
    {
        try
        {
            ...
            info = MReflect.GetType(targetType).GetEvent(eventName);
...
public static class ReflectionCache
{
    ...
    public static MethodInfo GetMethod(string signature)
    {
        ...
        if (!methods.TryGetValue(signature, out method))
            MReflect.ToMethod(signature, out method);
