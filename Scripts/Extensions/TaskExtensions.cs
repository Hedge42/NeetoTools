...
{
    public static UniTask.Awaiter GetAwaiter(this MTask state) => state.task.GetAwaiter();
    public static async UniTask WithCallback(this UniTask task, Action<UniTaskStatus> callback)
    {
        try
        {
            await task.Preserve();
...
public struct MTask
{
    ...
    public MTask Switch(params UniTask[] tasks)
    {
        cts = cts.Refresh();
    ...
    public MTask Switch(Func<CancellationToken, UniTask> GetTask)
    {
        cts = cts.Refresh();
    ...
    public MTask Switch(UniTask _task, Action __onComplete)
    {
        cts = cts.Refresh();
    ...
    public MTask Switch(UniTask _task, CancellationToken _token)
    {
        cts = cts.Refresh();
    ...
    public MTask Repeat(params UniTask[] tasks)
    {
        cts = cts.Refresh();
        task = UniTask.WhenAll(tasks)
            .AttachExternalCancellation(cts.Token)
    ...
    public static MTask Run(params UniTask[] tasks)
    {
        return new MTask().Switch(tasks);
    }
    ...
    public static MTask operator %(MTask state, UniTask task) => state.Switch(task);
    public static MTask operator +(MTask state, UniTask task)
    {
...
public static class MCancel
{
    ...
    public static void CreateLoop(PlayerLoopTiming timing, Action action, ref MTask state)
    {
        state.Switch(LoopAsync(timing, action));
    }
    public static void CreateLoop(this Action action, PlayerLoopTiming timing, ref MTask state)
    {
        state.Switch(LoopAsync(timing, action));
    }
