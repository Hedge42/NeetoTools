...
public class ExposedObjectAttribute : PropertyAttribute { }

#if UNITY_EDITOR
[CustomPropertyDrawer(typeof(ExposedObjectAttribute))]
public class ExposedScriptableObjectAttributeDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (property.isExpanded)
        {
            ...
            //{
            //    if (!editor || editor.serializedObject == null || editor.serializedObject.targetObject != property.objectReferenceValue)
            //}
