...
namespace Neeto
{
    [CreateAssetMenu(menuName = MenuPath.Neeto + nameof(ScriptableRichText), order = int.MinValue)]
    public class ScriptableRichText : ScriptableObject
    {
        public string value;
        public int fontSize;
        public bool edit;
...
#if UNITY_EDITOR
    [CustomEditor(typeof(ScriptableRichText))]
    public class ReadmeAssetEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            (target as ScriptableRichText).edit = false;
        }
        ...
        {
            var _target = target as ScriptableRichText;
