...
namespace Neeto
{
    [CreateAssetMenu(menuName = MenuPath.Neeto + nameof(ScriptableNote), order = int.MinValue)]
...
#if UNITY_EDITOR
    [CustomEditor(typeof(ScriptableNote))]
    public class ReadmeAssetEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            (target as ScriptableNote).edit = false;
        }
        ...
        {
            var _target = target as ScriptableNote;
