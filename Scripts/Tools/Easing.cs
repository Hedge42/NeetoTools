...
namespace Neeto
{
    ...
    public static class Easing
    {
        ...
        {
            await Ease(TaskHelper.GetDeltaTime, start, end, duration, method, action, timing, token, isPaused);
        }
        ...
        {
            await Ease(TaskHelper.GetUnscaledDeltaTime, start, end, duration, method, action, timing, token, isPaused);
        }
