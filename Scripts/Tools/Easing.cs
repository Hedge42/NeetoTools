...
namespace Neeto
{
    ...
    public static class Easing
    {
        ...
        {
            await Ease(MCancel.GetDeltaTime, start, end, duration, method, action, timing, token, isPaused);
        }
        ...
        {
            await Ease(MCancel.GetUnscaledDeltaTime, start, end, duration, method, action, timing, token, isPaused);
        }
