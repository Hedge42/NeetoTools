...
#if UNITY_EDITOR
using UnityEditor;
[CustomPropertyDrawer(typeof(RichTooltipAttribute))]
public class RichTooltipDrawer : DecoratorDrawer
{
    GUIStyle style;
    float height;
    ...
    public override void OnGUI(Rect position)
    {
        ...
        var target = attribute as RichTooltipAttribute;
    ...
    private void ValidateStyle()
    {
        ...
        style.richText = (attribute as RichTooltipAttribute).richText;
        style.stretchHeight = true;
        style.clipping = TextClipping.Overflow;
        style.alignment = (attribute as RichTooltipAttribute).alignment;
    }
}
#endif

[AttributeUsage(AttributeTargets.Field | AttributeTargets.Property, AllowMultiple = true)]
public class RichTooltipAttribute : PropertyAttribute
{
    ...
    public RichTooltipAttribute(string tooltip, TextAnchor alignment = TextAnchor.LowerLeft, float brightness = .73f, bool richText = true, int _fontSize = 10)
    {
